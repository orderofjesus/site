...
export default function Home() {
  return (
    <div
      className={`${manrope.className} min-h-screen bg-[#f6f7fb] text-zinc-900`}
    >
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6 md:px-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p
              className={`${playfair.className} text-xl font-bold leading-tight`}
            >
              Melchizedek
            </p>
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-16 px-6 pb-20 md:px-10 lg:gap-20">
        ...
        >
          ...
          <div className="relative flex flex-col gap-8 px-8 py-14 md:flex-row md:items-end md:justify-between md:px-12">
            <div className="max-w-xl space-y-6">
              <p className="text-xs uppercase tracking-[0.32em] text-[#8fd9ff]">
                Welcome home
              </p>
              <h1
                className={`${playfair.className} text-4xl leading-[1.1] md:text-5xl lg:text-6xl`}
              >
            ...
            <div className="w-full max-w-sm rounded-2xl bg-white/10 p-5 backdrop-blur-md md:w-auto">
              ...
              <div className="mt-4 space-y-4">
                <div className="rounded-xl bg-white/5 p-4">
                  <p className="text-xs uppercase tracking-[0.2em] text-[#8fd9ff]">
                    9:00 AM
                  </p>
        ...
        >
          <div className="md:col-span-1">
            <p className="text-xs uppercase tracking-[0.28em] text-[#0f92ff]">
              Start here
            </p>
            <h2 className={`${playfair.className} mt-3 text-3xl leading-tight`}>
        ...
        <section id="connect" className="space-y-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className={`${playfair.className} text-3xl leading-tight`}>
                Move with us.
              </h2>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                ...
                <h3 className={`${playfair.className} mt-3 text-2xl`}>
                  {card.title}
                </h3>
        ...
        >
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0f92ff]/80 via-[#0dbde6]/70 to-[#0f92ff]/50 blur-3xl opacity-60" />
            <div className="relative overflow-hidden rounded-2xl bg-neutral-900 text-white shadow-2xl">
              ...
              <div className="relative flex h-full flex-col justify-end p-8">
                ...
                <h3 className={`${playfair.className} mt-2 text-2xl`}>
                  Friday, 7:00 PM
                </h3>
        ...
        <section className="rounded-3xl bg-neutral-900 px-8 py-12 text-white shadow-2xl shadow-blue-200/40 md:px-12">
          <div className="grid gap-6 md:grid-cols-3 md:items-center">
            <div className="md:col-span-2">
              ...
              <h2
                className={`${playfair.className} mt-2 text-3xl leading-tight`}
              >
