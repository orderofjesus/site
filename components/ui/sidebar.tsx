...
import { Hamburger, PanelLeftIcon } from "lucide-react";
  ...
  return (
    ...
    <button
      ...
      className={cn(
        ...
        "border-black/20 text-black hover:bg-black hover:text-white dark:border-white/20 dark:text-white dark:hover:bg-white dark:hover:text-black",
        className,
      )}
